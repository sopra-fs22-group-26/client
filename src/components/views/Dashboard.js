...
const Helper = () => {
  let instructionText ="On the first sight, ScrumbleBee can be confusing.\n " +
      ...
      "On the RIGHT hand side you can create a new task, see your overall work estimate for the week and have a look at \n pending or already running Poll sessions.\n"+
      "\n" +
      "In the MIDDLE you have have an overview of all the tasks. If you switch to reports, only tasks are displayed which \n are completed and need to be rated by you.\n" +
      "\n" +
  ...
  return (
      <div>
        ...
        <Dialog maxWidth="100" maxHeight="80"
            open={open}
            onClose={handleClose}
